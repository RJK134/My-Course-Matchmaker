...
// 122 courses - compact format: t=title,inst=institution,co=country,ci=city,lev=level,mo=mode,dom=domain,sub=subjects,fH=feeHome,fI=feeIntl,liv=livingCost,dur=duration,rank=ranking,en=entry,car=careers,sal=salary,emp=employability,on=online,fr=free
const C=[
// PERFORMING ARTS (14)
